...
# Display RGB bars
echo "Red:"
display_rgb_bar $RED 1  # Adjust the bar width (currently set to 1)

echo "Green:"
display_rgb_bar $GREEN 1  # Adjust the bar width (currently set to 1)

echo "Blue:"
display_rgb_bar $BLUE 1  # Adjust the bar width (currently set to 1)
